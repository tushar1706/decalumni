...
router.get('/:uid', function(req, res, next) {
    ...
    sess=req.session;
     //fetching data
     var sqry = "select * from personal_info where user_id= '"+ req.params.uid +"' ";
     var sqry2 = "select * from user_details where user_id= '"+  req.params.uid +"' ";
  
     var cjob_qry = "select * from 	current_job where user_id= '"+  req.params.uid +"' ";
     var pjob_qry = "select * from previous_job where user_id= '"+  req.params.uid +"' ";
